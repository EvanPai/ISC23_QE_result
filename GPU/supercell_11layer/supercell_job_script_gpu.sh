...
#SBATCH -o supercell_gpu-%j.out                # Path to the standard output file
#SBATCH -e supercell_gpu-%j.err                # Path to the standard error ouput file
...
cd /jet/home/hpeng1/qe_john/supercell_11layer
